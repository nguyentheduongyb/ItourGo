                                        ...
                                        <div className="flex gap-4 text-[15px]">
                                                <div className="dropdown-hover uppercase flex items-center gap-1 relative py-3 text-[color:var(--primary-color)]">Trang chủ<MdKeyboardArrowDown fontSize={22} />
                                                        <ul className="dropdown-menu hidden w-60 absolute top-[100%] bg-white drop-shadow-[0_0_10px_rgba(0,0,0,0.25)] text-black">
                                                                <li className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] hover:text-white"><Link href="/tour/search/tour-viet-nam">Tour</Link></li>
                                                                <li className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] hover:text-white"><Link href="/hotel">Khách sạn</Link></li>
                                                                <li className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] hover:text-white"><Link href="/restaurant">Nhà hàng</Link></li>
                                                                <li className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] hover:text-white dropdown-subhover relative">
                                                                        ...
                                                                        <div className="dropdown-submenu hidden w-48 absolute left-[100%] top-0 bg-white">
                                                                                <div className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] text-black hover:text-white"><Link href="">Xe Bus</Link></div>
                                                                                <div className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] text-black hover:text-white"><Link href="">Xe Khách</Link></div>
                                                                                <div className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] text-black hover:text-white"><Link href="">Tàu Thuyền</Link></div>
                                                                                <div className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] text-black hover:text-white"><Link href="/airline-ticket">Vé Máy Bay</Link></div>
                                                                        </div>
                                                                </li>
                                                        </ul>
                                                </div>
                                                <div className="dropdown-hover uppercase flex items-center gap-1 relative py-3">Địa điểm<MdKeyboardArrowDown fontSize={22} />
                                                        <ul className="dropdown-menu w-52 hidden overflow-hidden absolute top-[100%] bg-white drop-shadow-[0_0_10px_rgba(0,0,0,0.25)] rounded-sm text-">
                                                                <li className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] hover:text-white"><Link href="">Miền Bắc</Link></li>
                                                                <li className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] hover:text-white"><Link href="">Miền Trung</Link></li>
                                                                <li className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] hover:text-white"><Link href="">Miền Nam</Link></li>
                                                                <li className="p-3 border-b last:border-b-0 border-dotted hover:bg-[color:var(--primary-color)] hover:text-white"><Link href="">Du lịch nước ngoài</Link></li>
                                                        </ul>
                                                </div>
